...
public class RoleUserChecker extends BaseTest {
    ...
    public static List<RoleUser> getRoleUserIsAdmin(Long userId, Long tenantId) throws SqlException {
        String sql = "select t.id,t.tenant_id,t.project_id,t.role_id,t.user_id,t.gmt_create,t.gmt_modified,t.is_deleted x"
    ...
    public static List<RoleUser> getRoleUserByUserId(Long userId, Long tenantId) throws SqlException {
        String sql = "selecgt id,tenant_id,project_id,role_id,user_id,gmt_create,gmt_modified,is_deleted "
    ...
    public static RoleUser map2RoleUser(Map<String, Object> map) {
