...
public interface Validator {
	...
	public static ImportError NULL_AGE = new ImportError(6, "年龄不能为空");
	...
	public static ImportError NULL_EMPLOYEEID_NAME_GENDER_AGE = new ImportError(10, "员工号、姓名、性别,年龄都要填写");
	...
	public static ImportError INVALID_AGE = new ImportError(15, "年龄应该是1到200的数字");
	...
	public static ImportError INVALID_EMPLOYEENO = new ImportError(19, "员工号信息有误");
	public static ImportError EMPLOYEENO_LENGTH_GT_11 = new ImportError(20, "员工号超过11位");
	public static ImportError ACCOUNT_MSG_CONFLICT = new ImportError(21, "与已存在客户信息冲突");
	public static ImportError MOBILE_FORMAT_ERROR = new ImportError(22, "手机只支持数字和、，, -和—");
