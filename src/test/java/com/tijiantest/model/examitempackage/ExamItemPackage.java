...
//加项包
public class ExamItemPackage implements Serializable {
	...
	private List<ExamItemPackage> packageTags;// 标签列表
	...
	public List<ExamItemPackage> getPackageTags() {
		return packageTags;
	}

	public void setPackageTags(List<ExamItemPackage> packageTags) {
